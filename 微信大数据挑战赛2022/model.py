...
from category_id_map import CATEGORY_ID_LIST, LV1_CATEGORY_ID_LIST,LV2_NUMS

class MultiModal_lv2(nn.Module):
    def __init__(self, args,lv1_id):
        super().__init__()
        ...
        self.classifier = nn.Linear(args.fc_size, LV2_NUMS[int(lv1_id)])

    def forward(self, inputs, inference=False):
        bert_embedding = self.bert(inputs['title_input'], inputs['title_mask'])['pooler_output']
        #bert_embedding2 = self.bert2(inputs['asr_input'], inputs['asr_mask'])['pooler_output']
...
class MultiModal(nn.Module):
    def __init__(self, args):
        ...
        bert_output_size = 768
        self.fusion = ConcatDenseSE(args.vlad_hidden_size + bert_output_size, args.fc_size, args.se_ratio, args.dropout)
        self.classifier = nn.Linear(args.fc_size, len(LV1_CATEGORY_ID_LIST))
