...
if __name__ == '__main__':
    ...
    train = pd.read_csv('../../../wbdc2021/data/wedata/wechat_algo_data2/user_action.csv')
    train_2 = pd.read_csv('../../../wbdc2021/data/wedata/wechat_algo_data1/user_action.csv')
    ...
    df = pd.concat([df,train2], axis=0, ignore_index=True)
