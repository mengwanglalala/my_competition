...
def evaluate_lv1(predictions, labels):
    # prediction and labels are all level-2 class ids

    lv1_preds = predictions
    lv1_labels = labels
...
def evaluate_lv2(predictions, labels):
    # prediction and labels are all level-2 class ids

    lv2_preds = predictions
    lv2_labels = labels

    lv2_f1_micro = f1_score(lv2_preds, lv2_labels, average='micro')
    lv2_f1_macro = f1_score(lv2_preds, lv2_labels, average='macro')
    #mean_f1 = (lv2_f1_macro + lv1_f1_macro + lv1_f1_micro + lv2_f1_micro) / 4.0
