...
def main(argv):
    ...
    train_model.save_weights(MODEL_PATH + 'mmoe_seed_' + str(SEED) + '_click_follow' + '.h5')
    ...
    try:
        submit.to_csv(SUB_PATH + 'targ_click_follow_seed_' + str(SEED) + '_sub_%.6f_%.6f_%.6f_%.6f.csv' % (
