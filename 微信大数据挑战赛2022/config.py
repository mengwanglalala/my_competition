...
#     parser.add_argument('--ckpt_file', type=str, default='save/v1/model_lv1_epoch_0_macro_f1_0.25_micro_f1_0.6.bin')
...
#     parser.add_argument('--bert_seq_length', type=int, default=1)
#     parser.add_argument('--bert_ocr_seq_length', type=int, default=1)
#     parser.add_argument('--bert_asr_seq_length', type=int, default=1)
...
def parse_args():
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/v2_two_step_pre')
    parser.add_argument('--ckpt_file', type=str, default='save/v2_two_step_pre/model_lv1_epoch_5_macro_f1_0.6928_micro_f1_0.7228.bin')
    parser.add_argument('--best_score', default=0, type=float, help='save checkpoint if mean_f1 > best_score')
    ...
    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='hfl/chinese-macbert-base')#chinese-macbert-base，chinese-bert-wwm-ext
    parser.add_argument('--bert_cache', type=str, default='data/cache')
    parser.add_argument('--bert_seq_length', type=int, default=100)
    parser.add_argument('--bert_ocr_seq_length', type=int, default=100)
    parser.add_argument('--bert_asr_seq_length', type=int, default=100)
    parser.add_argument('--bert_learning_rate', type=float, default=3e-5)#2e-5(GDY说有点低),2e-4
    parser.add_argument('--bert_warmup_steps', type=int, default=5000)
    parser.add_argument('--bert_max_steps', type=int, default=30000)
    parser.add_argument("--bert_hidden_dropout_prob", type=float, default=0.1)
