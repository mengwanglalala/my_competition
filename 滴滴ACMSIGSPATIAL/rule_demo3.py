...
def get_link_fea(links, crosses):
    ...
    state_0_std = np.std(state_0_list, ddof=1)
    state_1_std = np.std(state_1_list, ddof=1)
    state_2_std = np.std(state_2_list, ddof=1)
    state_3_std = np.std(state_3_list, ddof=1)
    ...
    try:
        ...
        return maps, sum_link_time, sum_link_time_w, sum_cross_time, sum_stut, maps2, link_states_start, link_states_true, state_sum_time,state_0_std,state_1_std,state_2_std,state_3_std
...
df_test_head['state_std_time_0']= 0  #
df_test_head['state_std_time_1']= 0  #
df_test_head['state_std_time_2']= 0  #
df_test_head['state_std_time_3']= 0  #
...
for i in tqdm(range(len(df_test_head))):
    link, t_t, w_t, c_t, s_t , cross, link_states_start, link_states_true, state_sum_time, state_0_std,state_1_std,state_2_std,state_3_std = get_link_fea(df_test_link.loc[[i]].values[0], df_test_cross.loc[[i]].values[0])
    ...
    df_test_head['state_std_time_0'][i] = state_0_std  #
    df_test_head['state_std_time_1'][i] = state_1_std  #
    df_test_head['state_std_time_2'][i] = state_2_std  #
    df_test_head['state_std_time_3'][i] = state_3_std  #
...
for file in tqdm(filenames):
    ...
    df_train_head['state_std_time_0'] = 0  #
    df_train_head['state_std_time_1'] = 0  #
    df_train_head['state_std_time_2'] = 0  #
    df_train_head['state_std_time_3'] = 0  #
    links = []
    crosses =[]
    for i in range(len(df_train_head)):
        link, t_t, w_t, c_t, s_t, cross, link_states_start, link_states_true, state_sum_time,  state_0_std,state_1_std,state_2_std,state_3_std = get_link_fea(df_train_link.loc[[i]].values[0], df_train_cross.loc[[i]].values[0])
        ...
        df_train_head['state_std_time_0'][i] = state_0_std  #
        df_train_head['state_std_time_1'][i] = state_1_std  #
        df_train_head['state_std_time_2'][i] = state_2_std  #
        df_train_head['state_std_time_3'][i] = state_3_std  #
        links.append(link)
